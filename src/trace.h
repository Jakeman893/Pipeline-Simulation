...
typedef struct Trace_Rec_Struct {
    ...
    uint8_t  dest_needed; // Destination register used with this instruction (bool)
    uint8_t  src1_reg;       // Source Register 1
    uint8_t  src2_reg;       // Source Register 2
    uint8_t  src1_needed; // Source Register 1 needed by this instruction (bool)
    uint8_t  src2_needed; // Source Register 2 needed to this instruction (bool)
